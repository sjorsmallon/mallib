...
void game::init_cvars()
{
    ...
    cvar::register_cvar_float("r_z_near", float{0.01f},  (Cvar_Flags::CVAR_RENDERER), "z-near value in clip space (projection matrix)", 0.01f, 0.01f, {});
    cvar::register_cvar_float("r_z_far",  float{2000.0f}, (Cvar_Flags::CVAR_RENDERER), "z-near value in clip space (projection matrix)", 200.0f, 1000.0f, {});
    cvar::register_cvar_float("r_fb_width",  float{1920.0f}, (Cvar_Flags::CVAR_RENDERER), "Width of the framebuffer.", 0, 10^6, {});
    cvar::register_cvar_float("r_fb_height",  float{1080.0f}, (Cvar_Flags::CVAR_RENDERER), "Height of the framebuffer.", 0, 10^6, {});
    ...
    cvar::register_cvar_int("sys_display_width", int32_t{1920}, (Cvar_Flags::CVAR_SYSTEM), "The display width.", int32_t{30}, int32_t{200}, {});
    cvar::register_cvar_int("sys_display_height", int32_t{1080}, (Cvar_Flags::CVAR_SYSTEM), "The display height.", int32_t{30}, int32_t{200}, {});
...
void game::main_loop()
{
    ...
    rm::swap_buffers(render_manager);
