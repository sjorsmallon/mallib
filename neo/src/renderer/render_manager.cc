...
#include "../framework/cvar/cvar_system.h"
...
void rm::init_imgui(Render_Manager& render_manager)
{
    ...
    ImGui_ImplWin32_Init(render_manager.win32_context.window_handle);
...
void rm::render_ui()
{
    ...
    float window_width = cvar::get_float("r_fb_width");
    float window_height = cvar::get_float("r_fb_height");
...
void rm::swap_buffers(Render_Manager& render_manager)
{
    SwapBuffers(render_manager.win32_context.device_context);
}
